...
static void ShowDemoWindowWidgets()
{
    ...
    if (ImGui::TreeNode("Trees"))
    {
        ...
        if (ImGui::TreeNode("Advanced, with Selectable nodes"))
        {
            ...
            ImGui::Checkbox("OnRender tree node as drag source", &test_drag_and_drop);
            ImGui::Text("Hello!");
    ...
    if (ImGui::TreeNode("Text"))
    {
        ...
        if (ImGui::TreeNode("Word Wrapping"))
        {
            ...
            for (int n = 0; n < 2; n++)
            {
                ImGui::Text("OnRender paragraph %d:", n);
...
static void ShowDemoWindowLayout()
{
    ...
    if (ImGui::TreeNode("Scrolling"))
    {
        ...
        if (show_horizontal_contents_size_demo_window)
        {
            ...
            HelpMarker("OnRender of different widgets react and impact the work rectangle growing when horizontal scrolling is enabled.\n\nUse 'Metrics->Tools->Show windows rectangles' to visualize rectangles.");
...
static void ShowExampleAppLongText(bool* p_open)
{
    ...
    ImGui::Combo("OnRender type", &test_type,
...
void ShowExampleAppDocuments(bool* p_open)
{
    ...
    // Submit Tab Bar and Tabs
    {
        ...
        if (ImGui::BeginTabBar("##tabs", tab_bar_flags))
        {
            ...
            // [DEBUG] Stress tests
            //if ((ImGui::GetFrameCount() % 30) == 0) docs[1].Open ^= 1;            // [DEBUG] Automatically show/hide a tab. OnRender various interactions e.g. dragging with this on.
            //if (ImGui::GetIO().KeyCtrl) ImGui::SetTabItemSelected(docs[1].Name);  // [DEBUG] OnRender SetTabItemSelected(), probably not very useful as-is anyway..
